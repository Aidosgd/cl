                ...
                <div class="contact-info__form">
                    ...
                    <form class="form form_contact" action="home-02.html" method="GET">
                        <div class="form-control form_contact__control">
                            <input class="form-control__input form_contact__control-input" type="text" placeholder="Имя">
                        </div>

                        <div class="form-control form_contact__control">
                            <input class="form-control__input form_contact__control-input" type="text" placeholder="Телефон">
                        </div>
                        <div class="form__wrapper-submit form_contact__wrapper-submit"><a class="form__submit-button button button_default button_large button_inverse" href="#">Отправить</a></div>
                    </form>
                </div>
                <div class="contact-info__content">
                    <ul class="list-contacts-2">
                        ...
                        <li class="list-contacts-2__item">
                            <div class="contact">
                                ...
                                <div class="contact__wrapper-content">
                                    <h3 class="contact__heading">Телефоны</h3><span class="contact__label">8 (708) 988 48 11</span><span class="contact__label">8 (747) 862 65 10</span>
                                </div>
                            </div>
                        </li>
                        {{--<li class="list-contacts-2__item">--}}
